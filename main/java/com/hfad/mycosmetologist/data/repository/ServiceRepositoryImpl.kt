...
class ServiceRepositoryImpl
    ...
    constructor(
        ...
        override fun createService(service: Service): Flow<Result<Unit>> =
            flow {
                emit(Result.Loading)
                try {
        ...
        override fun updateService(service: Service): Flow<Result<Unit>> =
            flow {
                emit(Result.Loading)
                try {
        ...
        override fun deleteService(service: Service): Flow<Result<Unit>> =
            flow {
                emit(Result.Loading)
                try {
        ...
        override fun getPriceList(workerId: String): Flow<Result<List<Service>>> =
            flow {
                emit(Result.Loading)
        ...
        override fun serviceIsExist(service: Service): Flow<Result<Boolean>> =
            flow {
                emit(Result.Loading)
